...
During this sprint our team implemented three more use cases: recommendations, citation generator, and a login function. Our main barrier was starting our project in C++. After the first sprint we decided to switch to using Python, so converting what we had already done took a little bit of time. 
...
We finished all of the work we assigned to each other
...
Desirables
(Remove this section when you save the file):
